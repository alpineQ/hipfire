#!/usr/bin/env bash
# asym3_score_one - hand-rolled native build for stage 2.6 MVP.
...
"$AIECC_BIN" \
    ...
    --peano="$PEANO" \
    --xclbin-name=asym3_score_one.xclbin \
...
ls -la main.pdi insts.bin asym3_score_one.xclbin 2>/dev/null || true
