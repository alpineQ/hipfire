...
static const ::aie::bfloat16 TURBO_C3[8] = {
    ::aie::bfloat16(-0.135f), ::aie::bfloat16(-0.083f),
    ::aie::bfloat16(-0.046f), ::aie::bfloat16(-0.015f),
    ::aie::bfloat16(+0.015f), ::aie::bfloat16(+0.046f),
    ::aie::bfloat16(+0.083f), ::aie::bfloat16(+0.135f),
};
...
static inline ::aie::vector<::aie::bfloat16, 16>
lookup_and_scale_16(const ::aie::vector<int8_t, 16> &idx,
                    const ::aie::vector<::aie::bfloat16, 16> &cnorm_v) {
  ::aie::vector<::aie::bfloat16, 16> result =
      ::aie::broadcast<::aie::bfloat16, 16>((::aie::bfloat16)0.0f);
  for (int e = 0; e < 8; ++e) {
    auto mask = ::aie::eq(idx, ::aie::broadcast<int8_t, 16>((int8_t)e));
    auto code_e = ::aie::broadcast<::aie::bfloat16, 16>(TURBO_C3[e]);
    result = ::aie::select(code_e, result, mask);
  }
  return ::aie::mul(result, cnorm_v).template to_vector<::aie::bfloat16>();
}
...
void asym3_dequant_256(uint8_t *packed, float *cnorm_ptr,
                       ::aie::bfloat16 *out) {
  ::aie::bfloat16 cnorm = (::aie::bfloat16)(*cnorm_ptr);
  ::aie::vector<::aie::bfloat16, 16> cnorm_v =
      ::aie::broadcast<::aie::bfloat16, 16>(cnorm);
  ...
  for (int c = 0; c < 16; ++c) {
    ...
    ::aie::vector<::aie::bfloat16, 16> v = lookup_and_scale_16(idx, cnorm_v);
