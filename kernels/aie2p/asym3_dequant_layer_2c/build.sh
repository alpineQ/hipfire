#!/usr/bin/env bash
# asym3_dequant_layer_2c - hand-rolled native build (2-core MVP).
...
"$AIECC_BIN" \
    ...
    --peano="$PEANO" \
    --xclbin-name=asym3_dequant_layer_2c.xclbin \
...
ls -la main.pdi insts.bin asym3_dequant_layer_2c.xclbin 2>/dev/null || true
